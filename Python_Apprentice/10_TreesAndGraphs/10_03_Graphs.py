...
class Graph(abc.ABC):
    ...
    @abc.abstractmethod  # @ stands for a decorator
    def add_edge(self, v1, v2, weight): # v1 is the source, v2 the destination
        pass
...
print(g.is_adjacent(0, 1))
print(g.is_adjacent(0, 2))
